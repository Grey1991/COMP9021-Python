...
#=====================================================================================
    ...
    if len(inflection_points) %2 != 0:
        ...
        if all(middle_x == (inflection_points[x][0] + inflection_points[len(inflection_points)//2+x][0])/2 and middle_y == (inflection_points[x][1] + inflection_points[len(inflection_points)//2+x][1])/2 for x in range(len(inflection_points) // 2)):
            if len(inflection_points) %4 ==0 and all([middle_y-inflection_points[x][1]+middle_x,inflection_points[x][0]-middle_x+middle_y] in inflection_points for x in range(len(inflection_points)//4)):
                invariant = 4
            else:
                invariant = 2
        else:
