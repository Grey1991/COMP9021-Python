...
class DoublyLinkedList:
    ...
    def duplicate(self):
        ...
        LL = DoublyLinkedList(key = self.key)
        LL.head = node_copy
        node = node.next_node
        while node:
            node_copy.next_node = Node(deepcopy(node.value))
            node_copy.next_node.pervious_node = node_copy
    ...
    def reverse(self):
        ...
        self.head.pervious_node = last_node
        self.head = last_node
    ...
    def append(self, value):
        ...
        node.next_node.pervious_node = node
    ...
    def insert_value_at(self, value, index):
        ...
        if index <= 0:
            ...
            self.head.pervious_node = new_node
            self.head = new_node
            return
        if not self.head:
            self.head = new_node
        ...
        new_node.pervious_node = node
        new_node.next_node = next_node
        if next_node:
            next_node.pervious_node = new_node
    ...
    def insert_value_before(self, value_1, value_2):
        ...
        node.next_node.pervious_node = new_node
        node.next_node = new_node
        new_node.pervious_node = node
        return True
